...
class dftm_ram():  
    ...
    def set_cycle_err(pmem, r_cycle, count):
        ...
        POS_CYCLE = INIT_CYCLE
        mem[POS_CYCLE   ] = cycle[ 0]
        mem[POS_CYCLE+ 1] = cycle[ 1]
        mem[POS_CYCLE+ 2] = cycle[ 2]
        mem[POS_CYCLE+ 3] = cycle[ 3]
        mem[POS_CYCLE+ 4] = cycle[ 4]
        mem[POS_CYCLE+ 5] = cycle[ 5]
        mem[POS_CYCLE+ 6] = cycle[ 6]
        mem[POS_CYCLE+ 7] = cycle[ 7]
        mem[POS_CYCLE+ 8] = cycle[ 8]
        mem[POS_CYCLE+ 9] = cycle[ 9]
        mem[POS_CYCLE+10] = cycle[10]
        mem[POS_CYCLE+11] = cycle[11]
        mem[POS_CYCLE+12] = cycle[12]
        mem[POS_CYCLE+13] = cycle[13]
        mem[POS_CYCLE+14] = cycle[14]
        mem[POS_CYCLE+15] = cycle[15]
        mem[POS_CYCLE+16] = cycle[16]
        mem[POS_CYCLE+17] = cycle[17]
        mem[POS_CYCLE+18] = cycle[18]
        mem[POS_CYCLE+19] = cycle[19]
        mem[POS_CYCLE+20] = cycle[20]
        mem[POS_CYCLE+21] = cycle[21]
        mem[POS_CYCLE+22] = cycle[22]
        mem[POS_CYCLE+23] = cycle[23]
        mem[POS_CYCLE+24] = cycle[24]
        mem[POS_CYCLE+25] = cycle[25]
        mem[POS_CYCLE+26] = cycle[26]
        mem[POS_CYCLE+27] = cycle[27]
        mem[POS_CYCLE+27] = cycle[28]
        mem[POS_CYCLE+29] = cycle[29]
        mem[POS_CYCLE+30] = cycle[30]
        mem[POS_CYCLE+31] = cycle[31]
        return mem
