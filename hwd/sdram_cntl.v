...
always @(rfshcntr_r, timer_r, rd_in_progress_s, ba_r, host_intf_rd_i, activeflag_r[0], activeflag_r[1], activeflag_r[2], activeflag_r[3], sdatadir_r, activebank_r, bank_s, rastimer_r, activerow_r[0], activerow_r[1], activerow_r[2], activerow_r[3], host_intf_wr_i, cmd_r, row_s, rdpipeline_r, col_s, saddr_r, wrtimer_r, wr_in_progress_s, ba_x, reftimer_r, doactivate_s, state_r, activate_in_progress_s) begin: SDRAM_CNTL_COMB_FUNC
    integer index;
...
always @(saddr_r, bank_s, sdata_r, cmd_r, sdatadir_r) begin: SDRAM_CNTL_SDRAM_PIN_MAP
    sd_intf_cke = 1;
    sd_intf_cs = 0;
    sd_intf_ras = cmd_r[2];
    sd_intf_cas = cmd_r[1];
...
always @(bank_s, rastimer_r, activerow_r[0], activerow_r[1], activerow_r[2], activerow_r[3], wrtimer_r, activeflag_r[0], activeflag_r[1], activeflag_r[2], activeflag_r[3], sd_intf_dq, row_s, activebank_r, rdpipeline_r, sdramdata_r) begin: SDRAM_CNTL_DO_ACTIVE
